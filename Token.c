 ...
 * File: Token.c, token implementation and declaration of token types
 */
...
String *convertTokenTypeToString(TokenType type) {
    ...
    case OPERATOR_AND: return createString("OPERATOR_AND");
    case OPERATOR_OR: return createString("OPERATOR_OR");
